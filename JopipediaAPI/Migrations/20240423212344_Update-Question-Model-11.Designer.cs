...
namespace JopipediaAPI.Migrations
{
    ...
    [Migration("20240423212344_Update-Question-Model-11")]
    partial class UpdateQuestionModel11
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JopipediaAPI.Data.Model.Rank", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9300),
                            Index = 1,
                            Name = "rookie",
                            Status = true,
                            TopPoints = 500,
                            UpdatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9300)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9310),
                            Index = 4,
                            Name = "advanced",
                            Status = true,
                            TopPoints = 5000,
                            UpdatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9310)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("JopipediaAPI.Data.Model.Topic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9280),
                            Description = "General Knowledge Quizzes",
                            Status = true,
                            Title = "General-Knowledge",
                            UpdatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9280)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9270),
                            Description = "Biology Quizzes",
                            Status = true,
                            Title = "Biology",
                            UpdatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9270)
                        },
                        new
                        {
                            Id = new Guid("9869f417-39c3-449c-8250-1aefe0a7444b"),
                            CreatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9290),
                            Description = "Physics Quizzes",
                            Status = true,
                            Title = "Physics",
                            UpdatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9290)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9240),
                            Description = "Astronomy Quizzes",
                            Status = true,
                            Title = "Astronomy",
                            UpdatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9240)
                        });
                });
            ...
            modelBuilder.Entity("JopipediaAPI.Data.Model.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9320),
                            Description = "Can Create Topics, Disable Users and Create Events",
                            Name = "admin",
                            Status = true,
                            UpdatedAt = new DateTime(2024, 4, 23, 21, 23, 44, 387, DateTimeKind.Utc).AddTicks(9320)
                        },
                        new
                        {
