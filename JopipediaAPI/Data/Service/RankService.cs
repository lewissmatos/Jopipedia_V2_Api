...
public class RankService: IRankService
{
    ...
    async public Task<ServiceResponse<List<RankDTO>>> GetAll()
    {
        ...
        return ServiceResponse<List<RankDTO>>
            .Success(_mapper.Map<List<RankDTO>>(data), paginatedUserRanks.Meta);
    }
    ...
    async public Task<ServiceResponse<RankDTO>> GetById(Guid id)
    {
        ...
        if (userRank == null)
            return ServiceResponse<RankDTO>.NotFound("userRankNotFound", "User Rank not found");
        return ServiceResponse<RankDTO>.Success(_mapper.Map<RankDTO>(userRank));
    }
    ...
    async public Task<ServiceResponse<RankDTO>> Create(RankDTO rank)
    {
        ...
        return ServiceResponse<RankDTO>.Success(_mapper.Map<RankDTO>(newUserRank));
    }
    ...
    async public Task<ServiceResponse<RankDTO>> Update(Guid id, RankDTO rank)
    {
        ...
        await _context.SaveChangesAsync();
        return ServiceResponse<RankDTO>.Success(_mapper.Map<RankDTO>(userRankToUpdate));
    }
   ...
   async public Task<ServiceResponse<RankDTO>> Delete(Guid id)
    {
        ...
        await _context.SaveChangesAsync();
        return ServiceResponse<RankDTO>.Success(_mapper.Map<RankDTO>(userRankToDelete));
    }
}