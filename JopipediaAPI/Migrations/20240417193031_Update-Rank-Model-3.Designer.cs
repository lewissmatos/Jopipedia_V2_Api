...
namespace JopipediaAPI.Migrations
{
    ...
    [Migration("20240417193031_Update-Rank-Model-3")]
    partial class UpdateRankModel3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JopipediaAPI.Data.Model.Rank", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9040),
                            Index = 1,
                            Name = "rookie",
                            Status = true,
                            TopPoints = 500,
                            UpdatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9040)
                        },
                        new
                        {
                            Id = new Guid("61ffef2e-5dbe-4d5d-80c9-ca3081fd821f"),
                            CreatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9050),
                            Index = 2,
                            Name = "beginner",
                            Status = true,
                            TopPoints = 1500,
                            UpdatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9050)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("JopipediaAPI.Data.Model.Topic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9010),
                            Description = "General Knowledge Quizzes",
                            Status = true,
                            Title = "General-Knowledge",
                            UpdatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9010)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9000),
                            Description = "Biology Quizzes",
                            Status = true,
                            Title = "Biology",
                            UpdatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9000)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9020),
                            Description = "Music Quizzes",
                            Status = true,
                            Title = "Music",
                            UpdatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9020)
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(8980),
                            Description = "Astrology Quizzes",
                            Status = true,
                            Title = "Astrology",
                            UpdatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(8980)
                        });
                });
            ...
            modelBuilder.Entity("JopipediaAPI.Data.Model.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9060),
                            Description = "Can Create Topics, Disable Users and Create Events",
                            Name = "admin",
                            Status = true,
                            UpdatedAt = new DateTime(2024, 4, 17, 19, 30, 31, 187, DateTimeKind.Utc).AddTicks(9060)
                        },
                        new
                        {
